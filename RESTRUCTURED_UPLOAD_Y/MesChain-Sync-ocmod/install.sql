...
-- Log Tablosu
CREATE TABLE IF NOT EXISTS `PREFIX_meschain_log` (
...
INSERT INTO `PREFIX_meschain_marketplace` (`name`, `code`, `settings`, `status`, `sort_order`, `date_added`, `date_modified`) VALUES
