...
/**
 * MesChain Trendyol API Client - OpenCart 4.x
 * Mevcut MeschainTrendyolHelper'dan adapte edilmiştir
 *
...
class TrendyolClient
{
     ...
     * Mevcut helper'dan korunmuş güçlü kod
     */
    ...
    {
        return $this->makeApiRequest(
            'suppliers/' . $this->config->get('meschain_trendyol_supplier_id') . '/products/price-and-inventory',
            'POST',
            ['items' => [$updates]]
        );
    }
    ...
    {
        if ($this->config->get('meschain_trendyol_debug') && $this->log) {
            $logData = [
