# Log Analiz Rehberi (amazon)

## Amaç
Bu klasördeki her log dosyası, amazon modülünün işleyişi ve hataları hakkında atomik bilgi sağlar. Loglar, hem insanlar hem de yapay zekâlar tarafından kolayca analiz edilebilecek şekilde tasarlanmıştır.
