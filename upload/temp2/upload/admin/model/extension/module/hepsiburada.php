 ...
 * hepsiburada.php
 *
 * Amaç: Hepsiburada modülünün OpenCart yönetici paneli (admin) tarafındaki model dosyasıdır. Veritabanı işlemleri burada tanımlanır.
 *
 ...
 */
// Hepsiburada modülünün veritabanı işlemleri için model dosyası
