 ...
 * amazon_api.php
 *
 * Amaç: Amazon modülünün OpenCart mağaza (catalog) tarafındaki controller dosyasıdır. API ile sipariş, ürün, stok işlemleri burada yönetilir.
 *
 * Loglama: Tüm önemli işlemler ve hatalar amazon_api.log dosyasına kaydedilmelidir.
 ...
 */
// Amazon modülünün OpenCart mağaza tarafındaki controller dosyası
...
class ControllerExtensionModuleAmazonApi extends Controller {
    public function getStatus() {
        ...
        try {
            $json['status'] = 'OK';
            $json['message'] = 'Amazon API çalışıyor.';
    ...
    private function writeLog($user, $action, $message) {
        $log_file = DIR_LOGS . 'amazon_api.log';
