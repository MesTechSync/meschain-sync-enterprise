	...
	public function index(): string {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ((string)$this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'extension/module/meschain_trendyol')) {
				$meschain[] = [
					'name'	   => 'Trendyol',
					'href'     => $this->url->link('extension/module/meschain_trendyol', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/meschain_hepsiburada')) {
				$meschain[] = [
					'name'	   => 'Hepsiburada',
					'href'     => $this->url->link('extension/module/meschain_hepsiburada', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/meschain_ozon')) {
				$meschain[] = [
					'name'	   => 'Ozon',
					'href'     => $this->url->link('extension/module/meschain_ozon', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
