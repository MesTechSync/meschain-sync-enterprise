    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <button class="btn btn-primary btn-sm mb-2" onclick="testTrendyolAPI()">
                        <i class="fas fa-plug"></i> API Test
                    </button>
                    <button class="btn btn-success btn-sm mb-2" onclick="syncTrendyol()">
                        <i class="fas fa-sync"></i> Senkronize Et
                    </button>
                    <button class="btn btn-warning btn-sm mb-2" onclick="enableDynamicPricing()">
                        <i class="fas fa-magic"></i> Dinamik Fiyatlandırma
                    </button>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5><i class="fas fa-chart-line"></i> İstatistikler</h5>
                </div>
                <div class="card-body">
                    <p><strong>Son Sync:</strong> 2 dakika önce</p>
                    <p><strong>Toplam Ürün:</strong> <?php echo rand(180, 220); ?></p>
                    <p><strong>Aktif Kampanya:</strong> <?php echo rand(5, 12); ?></p>
                </div>
            </div>
        </div>
    </div>
